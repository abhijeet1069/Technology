...
/*
 ...
 In JAVA concurrency.monitor is implemented via synchronized keyword.
 
 A concurrency.monitor is a synchronization mechanism designed in early 1970.
 ...
 It provides following capabilities to concurrent programs:
 	...
 	2. Threads running in a concurrency.monitor can block awaiting certain conditions to become true.
 	3. A thread can notify one or more threads that conditions they are waiting on have been met.
 
 
 All objects in JAVA can be used as built in concurrency.monitor objects, which support 2 types of thread synchronization.
