package swing.oracleDocs.components;
 ...
 *    images/wavy.gif
 */
public class P2_BorderDemo extends JPanel {
    public P2_BorderDemo() {
    ...
    protected static ImageIcon createImageIcon(String path,
                                               String description) {
        java.net.URL imgURL = P2_BorderDemo.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        P2_BorderDemo newContentPane = new P2_BorderDemo();
